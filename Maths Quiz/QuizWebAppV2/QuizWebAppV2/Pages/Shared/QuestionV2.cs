namespace MathsQuizV2WebApp.Pages
{
    internal class QuestionV2
    {
        ...
        //Looping through the numbers a nd operators, adding them to a string and returing it 
        ...
        private decimal CalculateQuestionAnswer(decimal num1, decimal num2, string op)
        {
            decimal temp = 0;
            if (op == "+")
            {
            ...
            {
                temp = Convert.ToDecimal(Math.Pow(Convert.ToDouble(num1), Convert.ToDouble(num2)));
            }
            else
            {
                temp = num1 / num2;
